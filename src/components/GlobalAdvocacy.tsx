...
import { Globe2, Landmark, Users, MapPin, ShieldCheck, Briefcase } from 'lucide-react';
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-start gap-16 lg:gap-20">
          <div className="lg:w-1/2 space-y-8 text-left">
            ...
            <h2 className="text-2xl lg:text-3xl font-headline font-black text-primary leading-tight">Uluslararası Vizyon ve <br />Hak Savunuculuğu</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {stats.map((stat, i) => ( stat &&
                <div key={i} className="p-5 bg-muted/30 rounded-2xl border border-primary/5 hover:bg-white hover:shadow-md transition-all">
                  ...
                  <div className="text-lg font-black text-primary mb-1">{stat.value}</div>
            ...
            <div className="relative aspect-video lg:aspect-square rounded-[2rem] overflow-hidden shadow-2xl border-4 border-muted/20">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-primary/70 via-primary/20 to-transparent flex flex-col justify-end p-8 lg:p-10">
                <div className="flex items-center gap-2 text-white mb-3">
                  ...
                  <span className="font-black text-lg">Cenevre / Strazburg / New York</span>
                </div>
                <p className="text-white/80 text-sm font-medium">Uluslararası arenada engelli haklarının evrensel bir değer haline gelmesi için diplomatik çalışmalarımız sürüyor.</p>
              </div>
            </div>
          </div>
        </div>
