...
export function StrategicImpact({ externalImpactId, onClearExternal }: StrategicImpactProps) {
  ...
  return (
    <section id="nobel" className="py-6 bg-white relative overflow-hidden scroll-mt-16">
      {/* Background Decor */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <motion.div 
          ...
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          className="mt-6 bg-gradient-to-r from-primary to-blue-900 rounded-[2rem] p-5 lg:p-6 text-white relative overflow-hidden scroll-mt-16"
        >
