      ...
      <div id="iletisim" className="py-24 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto bg-white p-12 rounded-[3.5rem] shadow-2xl text-center space-y-6 border border-primary/10">
            ...
            <h3 className="text-4xl font-black text-primary">Teşekkür Ederiz!</h3>
        ...
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-20 items-center">
          <div className="lg:w-2/5 space-y-10">
            <div>
              ...
              <h2 className="text-4xl lg:text-6xl font-headline font-black text-primary leading-tight">Engelsiz Erişim ve Talep Formu</h2>
            </div>
            ...
            <div className="space-y-6 pt-6">
              <div className="flex items-center gap-6 p-6 bg-white rounded-3xl shadow-sm border border-primary/5">
                <div className="w-14 h-14 bg-secondary/10 text-secondary rounded-2xl flex items-center justify-center shrink-0">📍</div>
          ...
          <div className="lg:w-3/5 w-full">
            <div className="bg-white p-10 lg:p-16 rounded-[4rem] shadow-2xl border border-primary/5 relative">
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                  <div className="grid md:grid-cols-2 gap-8">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="font-black text-primary text-lg">Ad Soyad</FormLabel>
                          <FormControl>
                            <Input placeholder="Adınızı giriniz" {...field} className="h-16 rounded-2xl focus:ring-secondary border-muted text-lg px-6" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="font-black text-primary text-lg">E-posta</FormLabel>
                          <FormControl>
                            <Input placeholder="E-posta adresiniz" {...field} className="h-16 rounded-2xl focus:ring-secondary border-muted text-lg px-6" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="font-black text-primary text-lg">Talebiniz veya Mesajınız</FormLabel>
                        <FormControl>
                          <Textarea 
                            placeholder="Mesajınızı buraya yazınız..." 
                            className="min-h-[200px] rounded-2xl focus:ring-secondary border-muted resize-none p-6 text-lg"
                            {...field} 
                          />
                        </FormControl>
                        <FormMessage />
                  ...
                  <Button 
                    ...
                    className="w-full h-20 bg-primary hover:bg-primary/90 text-white font-black text-2xl rounded-[2rem] group transition-all shadow-2xl shadow-primary/30"
                  >
                    {isSubmitting ? (
                      ...
                      <>
                        Talebi İlet
                        <Send className="ml-4 h-8 w-8 group-hover:translate-x-2 group-hover:-translate-y-2 transition-transform" />
                      </>
                    )}
                  </Button>
                </form>
