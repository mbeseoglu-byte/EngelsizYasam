      ...
      <div className="container mx-auto px-4">
          ...
          <div className="col-span-2">
            <Link href="/" className="flex items-center gap-3 mb-8">
              ...
              <div className="flex flex-col">
                <span className="font-headline font-black text-2xl leading-tight">Engelsiz Dünya</span>
                <span className="text-xs uppercase tracking-[0.2em] text-secondary font-bold">Erişilebilir Gelecek</span>
              </div>
            </Link>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="text-white/40 text-sm">
            © {new Date().getFullYear()} Engelsiz Dünya Platformu. Tüm hakları saklıdır.
          </div>
